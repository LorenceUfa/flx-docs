...
The scope of this page is to detail the steps required to configure SnapRoute OpxFlexSwitch networking stack on a white box switch running ONIE (Open Network Install Environment) Or Standalone package.  
